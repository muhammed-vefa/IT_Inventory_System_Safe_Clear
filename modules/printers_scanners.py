...
printers_scanners_bp = Blueprint('printers_scanners', __name__)

@printers_scanners_bp.route('/get_all', methods=['GET'])
@require_auth
def get_all():
...
@printers_scanners_bp.route('/update', methods=['POST'])
@require_editor
def update_device():
    try:
        data = request.json
...
@printers_scanners_bp.route('/delete/<int:id>', methods=['DELETE'])
@require_editor
...
@printers_scanners_bp.route('/device/<int:device_id>', methods=['GET'])
@require_auth
...
@printers_scanners_bp.route('/check_serial', methods=['POST'])
@require_auth
def check_serial():
    try:
        data = request.json
...
@printers_scanners_bp.route('/auto_register', methods=['POST'])
@require_editor
def auto_register():
    try:
        data = request.json
