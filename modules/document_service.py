...
def generate_pdf_direct(t_type, items, photo_path=None):
    ...
    if t_type == "ZIMMET":
        ...
        pdf.set_font("ArialTR", "B", 10)
        kisi1_ad = items.get("kisi1_ad", "Yetkili Kişi 1")
        kisi2_ad = items.get("kisi2_ad", "Yetkili Kişi 2")
        kisi3_ad = items.get("kisi3_ad", "Geliştirici Personel")
        ...
        pdf.cell(45, 3, "ÖRNEK ÜST KURUM", align="C")
        pdf.set_xy(10, 32)
        pdf.cell(45, 3, "ÖRNEK KURUM ADI", align="C")
        
        pdf.set_xy(55, 15)
        pdf.set_font("ArialTR", "B", 12)
        pdf.cell(145, 10, "ÖRNEK KURUM ADI", align="C")
        pdf.set_xy(55, 22)
        ...
        pdf.set_font("ArialTR", "B", 10)
        pdf.set_xy(55, 14)
        pdf.cell(100, 6, "ÖRNEK KURUM ADI", align="C")
        pdf.set_font("ArialTR", "B", 14)
        pdf.set_xy(55, 22)
        ...
        birim_sorumlusu = items.get("birimSorumlusu", items.get("birim_sorumlusu", "Yetkili Kişi 1"))
