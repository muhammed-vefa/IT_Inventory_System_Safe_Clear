...
printers_barcode_readers_bp = Blueprint('printers_barcode_readers', __name__)

@printers_barcode_readers_bp.route('/get_all', methods=['GET'])
@require_auth
def get_all():
...
@printers_barcode_readers_bp.route('/update', methods=['POST'])
@require_editor
def update_device():
    try:
        data = request.json
...
@printers_barcode_readers_bp.route('/delete/<int:id>', methods=['DELETE'])
@require_editor
...
@printers_barcode_readers_bp.route('/device/<int:device_id>', methods=['GET'])
@require_auth
...
@printers_barcode_readers_bp.route('/check_serial', methods=['POST'])
@require_auth
def check_serial():
    try:
        data = request.json
...
@printers_barcode_readers_bp.route('/auto_register', methods=['POST'])
@require_editor
def auto_register():
    try:
        data = request.json
