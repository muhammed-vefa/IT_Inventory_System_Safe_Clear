...
def update_cups_printer_location_wizard(pr_no, new_location):
    ...
    CUPS_URL = "http://10.241.1.21:49631"
    CUPS_USER = "root"
    CUPS_PASS = "1234qqqQ"
    TIMEOUT = 30
...
### Sorun
Mobilden çıktı alınırken her seferinde CUPS sunucusuna (`http://10.241.1.21:49631`) sorgu atılarak yazıcı isimleri çekiliyordu. Bu işlem 1-2 saniye gecikmeye neden oluyordu.
...
def query_cups():
    ...
    cups_base_url = cups_config.get('base_url', 'http://10.241.1.21:49631').rstrip('/')
...
|---|---|---|
| PR-001 | 10.241.40.1 | `PR-001` |
| PR-038 | 10.241.40.38 | `PR-038` |
